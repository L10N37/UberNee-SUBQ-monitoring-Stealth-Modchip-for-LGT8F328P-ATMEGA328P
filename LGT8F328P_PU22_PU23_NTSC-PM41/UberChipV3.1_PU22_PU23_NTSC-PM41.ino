/*
  ...
  V3.1      Just added the ability to reset the modchip along with the console so you can restart a disc without a hard power off and on.
            5 secoond adjustment, just an interrupt on D2. Wire this to Reset.
*/
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(2), rst, LOW);
